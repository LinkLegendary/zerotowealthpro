...
Open the account at a different bank than your checking. Set the transfer to execute 24 hours after your paycheck posts. Name the account something specific — "Car Repair Fund" or "No More Overdrafts" — rather than "Savings." Research in behavioral economics finds that labeled savings accounts with specific goal names create psychological accountability toward the named purpose.  A [2016 study by Sussman and O'Brien in the *Journal of Marketing Research*](https://doi.org/10.1509/jmr.14.0455) suggested that account labeling can make people more deliberate about whether a withdrawal is genuinely warranted — a meaningful protection for accounts that are supposed to stay intact.
