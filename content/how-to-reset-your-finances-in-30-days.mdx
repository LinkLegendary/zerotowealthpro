...
**Small early wins sustain momentum.**  A [*2016 study*](https://academic.oup.com/jcr/article-abstract/44/2/231/2687777?redirectedFrom=fulltext)  published in the Journal of Consumer Research found that early visible progress on a goal—specifically in debt management—significantly increased the likelihood of consumers completing their payoff plan. By concentrating repayments on a single debt to see it disappear faster (the "small victories" effect), motivation was sustained across the entire 30-day reset and beyond.
