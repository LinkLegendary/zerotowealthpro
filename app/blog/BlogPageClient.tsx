  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="financial-tools-card not-prose mt-12 rounded-2xl border border-gray-100 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {FINANCIAL_TOOLS.map((tool) => (
              <Link
                key={tool.href}
                href={tool.href}
                className="financial-tools-link group rounded-xl border border-gray-100 bg-gray-50 p-4 text-left transition-all hover:border-[#4472C4]/30 hover:bg-white hover:shadow-md"
              >
                <div className="flex items-start gap-3">
                  <div className="financial-tools-icon flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#4472C4] to-[#1F4E78] text-xl text-white shadow-sm">
                    {tool.icon}
                  </div>
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="financial-tools-cta">Open calculator →</div>
                  </div>
                </div>
              </Link>
            ))}
          ...
          <div className="mt-6 border-t border-gray-200 pt-5 text-center">
            <Link
              ...
              className="financial-tools-main-link inline-flex items-center gap-2 text-sm font-bold"
            >
