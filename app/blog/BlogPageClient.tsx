        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 py-8 text-center">
          ...
          <div className="flex items-center justify-center gap-8 mt-2">
            <div className="text-center">
              ...
              <p className="text-blue-200 text-xs uppercase tracking-wider mt-0.5">Articles</p>
            </div>
            <div className="w-px h-8 bg-white/20" />
            <div className="text-center">
              <p className="text-2xl font-bold text-white">Free</p>
              <p className="text-blue-200 text-xs uppercase tracking-wider mt-0.5">Always</p>
            </div>
            <div className="w-px h-8 bg-white/20" />
            <div className="text-center">
              <p className="text-2xl font-bold text-white">5 min</p>
              <p className="text-blue-200 text-xs uppercase tracking-wider mt-0.5">Avg Read</p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        {filtered.length === 0 && query && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 text-lg font-medium">No results for "{query}"</p>
            <p className="text-gray-400 text-sm mt-1 mb-4">Try a different keyword.</p>
            <button
              onClick={() => setQuery('')}
        ...
        {/* Bottom CTA */}
        <div className="mt-12 bg-gradient-to-br from-[#1F4E78] to-[#4472C4] rounded-2xl p-8 text-center shadow-lg">
          <p className="text-white font-bold text-xl mb-2">Ready to get debt-free?</p>
          <p className="text-blue-100 text-sm mb-6">
            Try our advanced payoff calculator — Snowball, Avalanche & hybrid modes.
          </p>
          <a
            href="https://zerowealthacademy.gumroad.com/l/DebtCalculatorPlus"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-white text-[#1F4E78] font-bold px-6 py-3 rounded-full hover:bg-blue-50 transition-colors shadow"
          >
