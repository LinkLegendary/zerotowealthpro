      ...
      <div className="relative w-full overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 py-10 text-center">
          ...
          <p className="text-blue-100 text-lg max-w-xl mx-auto leading-relaxed">
            Built to simplify debt payoff using structured systems,
            behavioral psychology, and real financial math.
          </p>
        </div>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-[#1F4E78]">Why This Site Exists</h2>
          </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { icon: '❄️', title: 'Debt Snowball', desc: 'Pay smallest balances first for momentum' },
              { icon: '🏔️', title: 'Debt Avalanche', desc: 'Target highest interest to minimize cost' },
              { icon: '📊', title: 'Payoff Calculators', desc: 'Real timelines based on your numbers' },
              { icon: '🧠', title: 'Behavioral Finance', desc: 'Why we stay in debt and how to break free' },
              { icon: '💳', title: 'Credit Card Traps', desc: 'Minimum payments, APR, and hidden fees' },
              { icon: '🛠️', title: 'Budgeting Tools', desc: 'Apps and systems that actually work' },
            ].map((item) => (
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
          ...
          <div className="space-y-4">
            {[
              { label: 'No hype', desc: 'We show real numbers, not motivational fluff. Every strategy is backed by math.' },
              { label: 'No ads', desc: 'Content is written to help you, not to sell you a credit card or loan.' },
              { label: 'Structured systems', desc: 'Step-by-step frameworks you can follow regardless of income or debt size.' },
              { label: 'Behavioral awareness', desc: 'We acknowledge that money is emotional and build systems around real human behavior.' },
            ].map((item) => (
        ...
        <div className="bg-gradient-to-br from-[#1F4E78] to-[#4472C4] rounded-2xl p-8 shadow-lg">
          <h2 className="text-white font-bold text-xl text-center mb-6">By The Numbers</h2>
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              <p className="text-3xl font-bold text-white">$0</p>
              <p className="text-blue-200 text-xs mt-1 uppercase tracking-wider">Cost to read</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-white">100%</p>
              <p className="text-blue-200 text-xs mt-1 uppercase tracking-wider">Math-backed</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-white">1</p>
              <p className="text-blue-200 text-xs mt-1 uppercase tracking-wider">Clear goal</p>
            </div>
          </div>
        </div>
